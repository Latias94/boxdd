...
#[link(wasm_import_module = "box2d-sys-v1-double")]
unsafe extern "C" {
    #[doc = " Get the number of recorded bytes."]
...
#[link(wasm_import_module = "box2d-sys-v1-double")]
unsafe extern "C" {
    #[doc = " Get the memory currently held by keyframe snapshots, in bytes."]
