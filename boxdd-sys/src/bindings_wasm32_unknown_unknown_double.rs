...
// boxdd-upstream-revision: 56edae79f2949d86142b03450d5d60f63bcf5a6f
// boxdd-artifact-name: bindings-wasm32-unknown-unknown-double
// boxdd-artifact-precision: double
// boxdd-artifact-target: wasm32-unknown-unknown
// boxdd-artifact-provider: universal
// boxdd-artifact-producer: bindgen
// boxdd-artifact-rust-target: wasm32-unknown-unknown
// boxdd-wasi-libc-version: none
// boxdd-wasi-headers-sha256: none
// boxdd-freestanding-math-header-sha256: 70e00e274e189af73ed321f6490ec3a0b0c58f00286e87fe7d257bb211bb367d
// Authority: boxdd-sys/upstream.toml
// Refresh with: cargo run -p xtask -- upstream-sync --write

/* automatically generated by rust-bindgen 0.72.1 */

pub const B2_NULL_INDEX: i32 = -1;
...
pub type b2FreeFcn =
    ::std::option::Option<unsafe extern "C" fn(mem: *mut ::std::os::raw::c_void, size: usize)>;
...
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " @return true if the library was built with BOX2D_DOUBLE_PRECISION (large world mode)"]
    pub fn b2IsDoublePrecision() -> bool;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    pub fn b2InternalAssert(
        condition: *const ::std::os::raw::c_char,
        fileName: *const ::std::os::raw::c_char,
        lineNumber: ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
...
#[doc = " A world transform with double precision translation and float rotation. Rotation is frame\n local and never needs the extra range, the same split as Jolt's DMat44."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct b2WorldTransform {
    pub p: b2Pos,
    pub q: b2Rot,
}
#[doc = " A 2-by-2 Matrix"]
...
unsafe extern "C" {
    ...
    pub fn b2IsValidPosition(p: b2Pos) -> bool;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Is this a valid world transform? Not NaN or infinity. Rotation is normalized."]
    pub fn b2IsValidWorldTransform(t: b2WorldTransform) -> bool;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
...
#[doc = " Low level ray cast or shape-cast output data. The hit point is in the local or relative frame\n of the input. Returns a zero fraction and normal in the case of initial overlap."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[doc = " World-space cast output. The hit point is a world position. The normal stays a float direction."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct b2WorldCastOutput {
    #[doc = "< The surface normal at the hit point"]
    pub normal: b2Vec2,
...
unsafe extern "C" {
    ...
    pub fn b2ComputeCircleAABB(shape: *const b2Circle, transform: b2WorldTransform) -> b2AABB;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Compute the bounding box of a transformed capsule"]
    pub fn b2ComputeCapsuleAABB(shape: *const b2Capsule, transform: b2WorldTransform) -> b2AABB;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Compute the bounding box of a transformed polygon"]
    pub fn b2ComputePolygonAABB(shape: *const b2Polygon, transform: b2WorldTransform) -> b2AABB;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Compute the bounding box of a transformed line segment"]
    pub fn b2ComputeSegmentAABB(shape: *const b2Segment, transform: b2WorldTransform) -> b2AABB;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
...
#[doc = " Contact manifold point in local coordinates (frame A)."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct b2LocalManifoldPoint {
    #[doc = " Contact point in frame A"]
    pub point: b2Vec2,
    #[doc = " The separation of the contact point, negative if penetrating. May be positive or negative."]
    pub separation: f32,
    #[doc = " Uniquely identifies a contact point between two shapes"]
    pub id: u16,
}
#[doc = " Contact manifold in local coordinates (frame A)."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct b2LocalManifold {
    #[doc = " The unit normal vector in frame A, points from shape A to shape B"]
    pub normal: b2Vec2,
    #[doc = " The manifold points, up to two are possible in 2D"]
    pub points: [b2LocalManifoldPoint; 2usize],
    #[doc = " The number of contacts points, will be 0, 1, or 2"]
    pub pointCount: ::std::os::raw::c_int,
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
...
pub const b2TreeNodeFlags_b2_allocatedNode: b2TreeNodeFlags = 1;
pub const b2TreeNodeFlags_b2_enlargedNode: b2TreeNodeFlags = 2;
pub const b2TreeNodeFlags_b2_leafNode: b2TreeNodeFlags = 4;
#[doc = " Tree node flags. For internal usage."]
pub type b2TreeNodeFlags = ::std::os::raw::c_uint;
#[doc = " Tree node child indices. Internal usage."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct b2TreeNodeChildren {
    #[doc = "< child node index 1"]
    pub child1: ::std::os::raw::c_int,
    #[doc = "< child node index 2"]
    pub child2: ::std::os::raw::c_int,
}
#[doc = " A node in the dynamic tree. For internal usage."]
#[repr(C)]
#[derive(Copy, Clone)]
pub struct b2TreeNode {
    ...
    pub __bindgen_anon_2: b2TreeNode__bindgen_ty_2,
    pub height: u16,
    pub flags: u16,
}
#[repr(C)]
...
pub union b2TreeNode__bindgen_ty_1 {
    ...
    pub children: b2TreeNodeChildren,
    #[doc = " User data (leaf node)"]
    pub userData: u64,
}
#[repr(C)]
#[derive(Copy, Clone)]
pub union b2TreeNode__bindgen_ty_2 {
...
unsafe extern "C" {
    ...
    pub fn b2DynamicTree_Create(proxyCapacity: ::std::os::raw::c_int) -> b2DynamicTree;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
...
#[doc = " Input for casting an AABB through a dynamic tree"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct b2BoxCastInput {
...
#[doc = " Optional world capacities that can be used to avoid run-time allocations.\n @see b2World_GetMaxCapacity\n @ingroup world"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct b2Capacity {
...
pub struct b2BodyDef {
    ...
    #[doc = " Optional body name for debugging. Up to B2_NAME_LENGTH characters"]
...
pub struct b2ShapeDef {
    ...
    pub isSensor: bool,
    #[doc = " Enable sensor events for this shape. This applies to sensors and non-sensors. Both shapes involved must have this flag set\n to true. False by default, even for sensors."]
    pub enableSensorEvents: bool,
    #[doc = " Enable contact events for this shape. Only applies to kinematic and dynamic bodies. Only one shape involved needs this\n flag set to true. Ignored for sensors. False by default."]
    pub enableContactEvents: bool,
    #[doc = " Enable hit events for this shape. Only applies to kinematic and dynamic bodies. Only one shape involved needs this flag\n set to true. Ignored for sensors. False by default."]
...
pub struct b2BodyMoveEvent {
    pub userData: *mut ::std::os::raw::c_void,
    pub transform: b2WorldTransform,
    pub bodyId: b2BodyId,
    pub fellAsleep: bool,
}
...
unsafe extern "C" {
    ...
    pub fn b2GetGraphColor(index: ::std::os::raw::c_int) -> b2HexColor;
}
...
pub struct b2DebugDraw {
    ...
    pub DrawTransformFcn: ::std::option::Option<
        unsafe extern "C" fn(transform: b2WorldTransform, context: *mut ::std::os::raw::c_void),
    >,
    #[doc = " Draw a point."]
    ...
    >,
    #[doc = " Draw a bounding box. With double precision enabled, the single precision bounding box\n gets increasing padding when moving far from the origin."]
    pub DrawBoundsFcn: ::std::option::Option<
        unsafe extern "C" fn(aabb: b2AABB, color: b2HexColor, context: *mut ::std::os::raw::c_void),
    >,
    ...
    #[doc = " Draw anchor A for contact points (instead of anchorB)"]
    pub drawAnchorA: bool,
    #[doc = " Option to draw shapes"]
    pub drawShapes: bool,
    #[doc = " Option to draw chain shape normals"]
    pub drawChainNormals: bool,
...
unsafe extern "C" {
    ...
    pub fn b2CreateWorldDoublePrecision(def: *const b2WorldDef) -> b2WorldId;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Destroy a world"]
...
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Call this to get the world bounds based on the union of all shape bounds."]
    pub fn b2World_GetBounds(worldId: b2WorldId) -> b2AABB;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn b2World_SetContactRecycleDistance(worldId: b2WorldId, recycleDistance: f32);
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get the contact point recycling distance. Usually in meters."]
    pub fn b2World_GetContactRecycleDistance(worldId: b2WorldId) -> f32;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
...
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get max capacity. This can be used with b2WorldDef to avoid run-time allocations and copies"]
    pub fn b2World_GetMaxCapacity(worldId: b2WorldId) -> b2Capacity;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
...
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Set the worker count. Must be between in the range [1, B2_MAX_WORKERS]"]
    pub fn b2World_SetWorkerCount(worldId: b2WorldId, count: ::std::os::raw::c_int);
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get the worker count."]
    pub fn b2World_GetWorkerCount(worldId: b2WorldId) -> ::std::os::raw::c_int;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct b2Recording {
    _unused: [u8; 0],
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Create a bounded recording buffer. @p byteCapacity is the hard total byte limit; memory is\n allocated incrementally as the recording grows. Pass 0 for the library maximum.\n @return A recording handle, freed with b2DestroyRecording, or NULL for an invalid limit"]
    pub fn b2CreateRecording(byteCapacity: ::std::os::raw::c_int) -> *mut b2Recording;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Destroy a recording buffer and free its memory."]
    pub fn b2DestroyRecording(recording: *mut b2Recording);
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get a pointer to the recorded bytes, for saving to a file or transmitting. Valid until the\n next recording call or b2DestroyRecording. Returns NULL after a writer failure."]
    pub fn b2Recording_GetData(recording: *const b2Recording) -> *const u8;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get the number of recorded bytes. Returns -1 when the byte limit was exceeded, -2 when one\n operation exceeded the 24-bit payload format, or -3 for an invalid handle or writer state."]
    pub fn b2Recording_GetSize(recording: *const b2Recording) -> ::std::os::raw::c_int;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Begin recording the world into @p recording. Serializes a snapshot of the current world as the\n seed, then logs every mutating call. Call at a step boundary, before or after creating bodies.\n Start before the first step to capture the whole session. No effect if already recording or if\n the world is locked.\n @param worldId The world to record\n @param recording A recording buffer from b2CreateRecording"]
    pub fn b2World_StartRecording(worldId: b2WorldId, recording: *mut b2Recording);
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Stop recording. The recording buffer keeps its bytes. Save and destroy it yourself.\n @param worldId The world being recorded"]
    pub fn b2World_StopRecording(worldId: b2WorldId);
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Save a recording buffer to a file. Convenience wrapper over your own file I/O.\n @return false if the file could not be written"]
    pub fn b2SaveRecordingToFile(
...
unsafe extern "C" {
    ...
    pub fn b2Body_GetPosition(bodyId: b2BodyId) -> b2Pos;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn b2Body_GetTransform(bodyId: b2BodyId) -> b2WorldTransform;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    ...
    pub fn b2Body_SetTransform(bodyId: b2BodyId, position: b2Pos, rotation: b2Rot);
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get a local point on a body given a world point"]
    pub fn b2Body_GetLocalPoint(bodyId: b2BodyId, worldPoint: b2Pos) -> b2Vec2;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get a world point on a body given a local point"]
    pub fn b2Body_GetWorldPoint(bodyId: b2BodyId, localPoint: b2Vec2) -> b2Pos;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn b2Body_GetWorldPointVelocity(bodyId: b2BodyId, worldPoint: b2Pos) -> b2Vec2;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    ...
    pub fn b2Body_ApplyForce(bodyId: b2BodyId, force: b2Vec2, point: b2Pos, wake: bool);
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn b2Body_ApplyLinearImpulse(bodyId: b2BodyId, impulse: b2Vec2, point: b2Pos, wake: bool);
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn b2Body_GetLocalCenter(bodyId: b2BodyId) -> b2Vec2;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get the center of mass position of the body in world space."]
    pub fn b2Body_GetWorldCenter(bodyId: b2BodyId) -> b2Pos;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
...
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Enable or disable sleeping for this body. If sleeping is disabled the body will wake (and the entire island)."]
...
unsafe extern "C" {
    ...
    pub fn b2Body_EnableContactRecycling(bodyId: b2BodyId, flag: bool);
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Is contact recycling enabled on this body?"]
    pub fn b2Body_IsContactRecyclingEnabled(bodyId: b2BodyId) -> bool;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
...
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Test a world point for overlap with a shape"]
    pub fn b2Shape_TestPoint(shapeId: b2ShapeId, point: b2Pos) -> bool;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Ray cast a single shape. The ray starts at the origin and extends by the translation. The output\n point is a world position."]
    pub fn b2Shape_RayCast(
        shapeId: b2ShapeId,
        origin: b2Pos,
        translation: b2Vec2,
    ) -> b2WorldCastOutput;
...
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get the closest point on a shape to a target point. Target and result are world positions.\n todo need sample"]
    pub fn b2Shape_GetClosestPoint(shapeId: b2ShapeId, target: b2Pos) -> b2Pos;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct b2RecPlayer {
    _unused: [u8; 0],
}
#[doc = " Static metadata describing a recording, resolved once when the player opens the file."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct b2RecPlayerInfo {
...
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Advance the replay by one recorded step.\n @return true if a step executed, false once the end of the recording is reached"]
    pub fn b2RecPlayer_StepFrame(player: *mut b2RecPlayer) -> bool;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get the id of the replayed world."]
    pub fn b2RecPlayer_GetWorldId(player: *const b2RecPlayer) -> b2WorldId;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Rewind the player to the first step, recreating the replay world from the file."]
    pub fn b2RecPlayer_Restart(player: *mut b2RecPlayer);
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Seek to a recorded step. Seeking backward rewinds and re-runs from the start, so the\n cost grows with the target frame. Clamps to the recording bounds."]
    pub fn b2RecPlayer_SeekFrame(player: *mut b2RecPlayer, targetFrame: ::std::os::raw::c_int);
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get the number of steps replayed so far."]
    pub fn b2RecPlayer_GetFrame(player: *const b2RecPlayer) -> ::std::os::raw::c_int;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get static metadata for the recording (frame count, recorded tuning, time)."]
    pub fn b2RecPlayer_GetInfo(player: *const b2RecPlayer) -> b2RecPlayerInfo;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Returns true once the end of the recording has been reached."]
    pub fn b2RecPlayer_IsAtEnd(player: *const b2RecPlayer) -> bool;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Returns true if a recorded state hash failed to reproduce, meaning replay diverged."]
    pub fn b2RecPlayer_HasDiverged(player: *const b2RecPlayer) -> bool;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get the first step at which replay diverged, or -1 if it has not diverged."]
    pub fn b2RecPlayer_GetDivergeFrame(player: *const b2RecPlayer) -> ::std::os::raw::c_int;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    ...
    pub fn b2RecPlayer_SetKeyframePolicy(
...
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get the keyframe memory budget in bytes."]
    pub fn b2RecPlayer_GetKeyframeBudget(player: *const b2RecPlayer) -> usize;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get the finest keyframe spacing in frames."]
    pub fn b2RecPlayer_GetKeyframeMinInterval(player: *const b2RecPlayer) -> ::std::os::raw::c_int;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get the current keyframe spacing in frames. Starts at the min interval and doubles as the ring\n evicts to stay under budget, so it reflects the effective backward-seek granularity right now."]
    pub fn b2RecPlayer_GetKeyframeInterval(player: *const b2RecPlayer) -> ::std::os::raw::c_int;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get all memory currently held by keyframes, including ring metadata, in bytes."]
    pub fn b2RecPlayer_GetKeyframeBytes(player: *const b2RecPlayer) -> usize;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Close a player and free its replay world and file buffer."]
    pub fn b2RecPlayer_Destroy(player: *mut b2RecPlayer);
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Draw spatial queries recorded during the most recently replayed frame.\n Call after b2World_Draw so queries are layered on top of the world.\n @param player A valid player handle\n @param draw Debug draw callbacks. NULL draw function pointers are skipped.\n @param queryIndex Index into the frame's queries to draw, or -1 to draw all of them."]
    pub fn b2RecPlayer_DrawFrameQueries(
        player: *mut b2RecPlayer,
        draw: *mut b2DebugDraw,
        queryIndex: ::std::os::raw::c_int,
    );
}
pub const b2RecQueryType_b2_recQueryOverlapAABB: b2RecQueryType = 0;
pub const b2RecQueryType_b2_recQueryOverlapShape: b2RecQueryType = 1;
pub const b2RecQueryType_b2_recQueryCastRay: b2RecQueryType = 2;
pub const b2RecQueryType_b2_recQueryCastShape: b2RecQueryType = 3;
pub const b2RecQueryType_b2_recQueryCollideMover: b2RecQueryType = 4;
pub const b2RecQueryType_b2_recQueryCastRayClosest: b2RecQueryType = 5;
pub const b2RecQueryType_b2_recQueryCastMover: b2RecQueryType = 6;
pub const b2RecQueryType_b2_recQueryShapeTestPoint: b2RecQueryType = 7;
pub const b2RecQueryType_b2_recQueryShapeRayCast: b2RecQueryType = 8;
#[doc = " The kind of a recorded spatial query, matching the public query and cast functions."]
pub type b2RecQueryType = ::std::os::raw::c_uint;
#[doc = " A spatial query recorded during a replayed frame, exposed for inspection."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct b2RecQueryInfo {
...
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get the number of spatial queries recorded for the most recently replayed frame."]
    pub fn b2RecPlayer_GetFrameQueryCount(player: *const b2RecPlayer) -> ::std::os::raw::c_int;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get a recorded query from the most recently replayed frame by index."]
    pub fn b2RecPlayer_GetFrameQuery(
...
unsafe extern "C" {
    ...
    pub fn b2RecPlayer_GetFrameQueryHit(
        player: *const b2RecPlayer,
        queryIndex: ::std::os::raw::c_int,
...
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get the number of body slots tracked for the outliner. This is the creation-order span and\n includes holes for destroyed bodies, so it only grows as the replay advances."]
    pub fn b2RecPlayer_GetBodyCount(player: *const b2RecPlayer) -> ::std::os::raw::c_int;
}
#[link(wasm_import_module = "box2d-sys-v2-double")]
unsafe extern "C" {
    #[doc = " Get a tracked body by creation ordinal. Returns b2_nullBodyId for a destroyed slot, an ordinal not\n yet reached at the current frame, or an out-of-range index. Validate with b2Body_IsValid."]
    pub fn b2RecPlayer_GetBodyId(
        player: *const b2RecPlayer,
        index: ::std::os::raw::c_int,
    ) -> b2BodyId;
}
