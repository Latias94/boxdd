...
pub(crate) fn try_set_body_position_and_rotation_with_access<V: Into<Position>>(
    core: &WorldCore,
    body: BodyId,
    p: V,
    angle_radians: f32,
    ...
    check_body_target_with_access(core, body, access)?;
    let p = crate::body::check_valid_body_position(p.into())?;
    let angle_radians = crate::body::check_valid_body_float(angle_radians)?;
    check_body_target_with_access(core, body, access)?;
    let (s, c) = angle_radians.sin_cos();
    unsafe { ffi::b2Body_SetTransform(raw_body_id(body), p.into_raw(), ffi::b2Rot { c, s }) };
    Ok(())
}

pub(crate) fn try_set_body_linear_velocity_with_access<V: Into<Vec2>>(
    core: &WorldCore,
    body: BodyId,
    velocity: V,
    access: crate::core::world_core::WorldAccess,
    ...
    check_body_target_with_access(core, body, access)?;
    let velocity = crate::body::check_valid_body_vec2(velocity.into())?;
    check_body_target_with_access(core, body, access)?;
    unsafe { ffi::b2Body_SetLinearVelocity(raw_body_id(body), velocity.into_raw()) };
    Ok(())
}

pub(crate) fn try_set_body_angular_velocity_with_access(
    core: &WorldCore,
    body: BodyId,
    ...
    check_body_target_with_access(core, body, access)?;
    let angular_velocity = crate::body::check_valid_body_float(angular_velocity)?;
    unsafe { ffi::b2Body_SetAngularVelocity(raw_body_id(body), angular_velocity) };
    Ok(())
}

pub(crate) fn try_body_apply_linear_impulse_to_center_with_access<V: Into<Vec2>>(
    core: &WorldCore,
    body: BodyId,
    impulse: V,
    wake: bool,
    ...
    check_body_target_with_access(core, body, access)?;
    unsafe { ffi::b2Body_ApplyLinearImpulseToCenter(raw_body_id(body), impulse.into_raw(), wake) };
    Ok(())
}

pub(crate) fn try_body_apply_angular_impulse_with_access(
    core: &WorldCore,
    body: BodyId,
    impulse: f32,
    wake: bool,
...
pub(crate) fn try_body_clear_forces_with_access(
    core: &WorldCore,
    body: BodyId,
    access: crate::core::world_core::WorldAccess,
) -> crate::error::ApiResult<()> {
...
pub(crate) fn try_set_body_type_with_access(
    core: &WorldCore,
    body: BodyId,
    body_type: BodyType,
    access: crate::core::world_core::WorldAccess,
    ...
    check_body_target_with_access(core, body, access)?;
    unsafe { ffi::b2Body_SetType(raw_body_id(body), body_type.into_raw()) };
    Ok(())
}

pub(crate) fn try_set_body_target_transform_with_access(
    core: &WorldCore,
    body: BodyId,
...
pub(crate) fn try_body_apply_force_with_access<F: Into<Vec2>, P: Into<Position>>(
    core: &WorldCore,
    body: BodyId,
    force: F,
    point: P,
    ...
    check_body_target_with_access(core, body, access)?;
    let force = crate::body::check_valid_body_vec2(force.into())?;
    let point = crate::body::check_valid_body_position(point.into())?;
    check_body_target_with_access(core, body, access)?;
    let point = crate::body::check_body_world_point_in_local_range(
        point,
        crate::body::body_world_center_of_mass_impl(body),
    )?;
    unsafe { ffi::b2Body_ApplyForce(raw_body_id(body), force.into_raw(), point.into_raw(), wake) };
    Ok(())
}

pub(crate) fn try_body_apply_force_to_center_with_access<V: Into<Vec2>>(
    core: &WorldCore,
    body: BodyId,
    force: V,
    wake: bool,
    ...
    let force = crate::body::check_valid_body_vec2(force.into())?;
    check_body_target_with_access(core, body, access)?;
    unsafe { ffi::b2Body_ApplyForceToCenter(raw_body_id(body), force.into_raw(), wake) };
    Ok(())
}

pub(crate) fn try_body_apply_torque_with_access(
    core: &WorldCore,
    body: BodyId,
    torque: f32,
    wake: bool,
    ...
    check_body_target_with_access(core, body, access)?;
    let torque = crate::body::check_valid_body_float(torque)?;
    unsafe { ffi::b2Body_ApplyTorque(raw_body_id(body), torque, wake) };
    Ok(())
}

pub(crate) fn try_body_apply_linear_impulse_with_access<F: Into<Vec2>, P: Into<Position>>(
    core: &WorldCore,
    body: BodyId,
    impulse: F,
    point: P,
...
pub(crate) fn try_body_set_mass_data_with_access(
    core: &WorldCore,
    body: BodyId,
    mass_data: MassData,
    access: crate::core::world_core::WorldAccess,
...
pub(crate) fn try_body_apply_mass_from_shapes_with_access(
    core: &WorldCore,
    body: BodyId,
    access: crate::core::world_core::WorldAccess,
) -> crate::error::ApiResult<()> {
...
pub(crate) fn try_body_set_linear_damping_with_access(
    core: &WorldCore,
    body: BodyId,
    damping: f32,
    access: crate::core::world_core::WorldAccess,
    ...
    check_body_target_with_access(core, body, access)?;
    crate::body::check_non_negative_finite_body_scalar(damping)?;
    unsafe { ffi::b2Body_SetLinearDamping(raw_body_id(body), damping) };
    Ok(())
}

pub(crate) fn try_body_set_angular_damping_with_access(
    core: &WorldCore,
    body: BodyId,
    damping: f32,
    access: crate::core::world_core::WorldAccess,
    ...
    check_body_target_with_access(core, body, access)?;
    crate::body::check_non_negative_finite_body_scalar(damping)?;
    unsafe { ffi::b2Body_SetAngularDamping(raw_body_id(body), damping) };
    Ok(())
}

pub(crate) fn try_body_set_gravity_scale_with_access(
    core: &WorldCore,
    body: BodyId,
    scale: f32,
    access: crate::core::world_core::WorldAccess,
    ...
    check_body_target_with_access(core, body, access)?;
    if !crate::is_valid_float(scale) {
        return Err(crate::error::ApiError::InvalidArgument);
    }
    unsafe { ffi::b2Body_SetGravityScale(raw_body_id(body), scale) };
    Ok(())
}

pub(crate) fn try_body_set_awake_with_access(
    core: &WorldCore,
    body: BodyId,
    awake: bool,
    access: crate::core::world_core::WorldAccess,
    ...
    check_body_target_with_access(core, body, access)?;
    unsafe { ffi::b2Body_SetAwake(raw_body_id(body), awake) };
    Ok(())
}

pub(crate) fn try_body_wake_touching_with_access(
    core: &WorldCore,
    body: BodyId,
    access: crate::core::world_core::WorldAccess,
) -> crate::error::ApiResult<()> {
...
pub(crate) fn try_body_enable_sleep_with_access(
    core: &WorldCore,
    body: BodyId,
    flag: bool,
    access: crate::core::world_core::WorldAccess,
    ...
    check_body_target_with_access(core, body, access)?;
    unsafe { ffi::b2Body_EnableSleep(raw_body_id(body), flag) };
    Ok(())
}

pub(crate) fn try_body_set_sleep_threshold_with_access(
    core: &WorldCore,
    body: BodyId,
    threshold: f32,
    access: crate::core::world_core::WorldAccess,
    ...
    check_body_target_with_access(core, body, access)?;
    crate::body::check_non_negative_finite_body_scalar(threshold)?;
    unsafe { ffi::b2Body_SetSleepThreshold(raw_body_id(body), threshold) };
    Ok(())
}

pub(crate) fn try_body_enable_with_access(
    core: &WorldCore,
    body: BodyId,
    access: crate::core::world_core::WorldAccess,
) -> crate::error::ApiResult<()> {
    check_body_target_with_access(core, body, access)?;
    unsafe { ffi::b2Body_Enable(raw_body_id(body)) };
    Ok(())
}

pub(crate) fn try_body_disable_with_access(
    core: &WorldCore,
    body: BodyId,
    access: crate::core::world_core::WorldAccess,
) -> crate::error::ApiResult<()> {
    check_body_target_with_access(core, body, access)?;
    unsafe { ffi::b2Body_Disable(raw_body_id(body)) };
    Ok(())
}

pub(crate) fn try_body_set_motion_locks_with_access(
    core: &WorldCore,
    body: BodyId,
    locks: MotionLocks,
    access: crate::core::world_core::WorldAccess,
...
pub(crate) fn try_body_set_bullet_with_access(
    core: &WorldCore,
    body: BodyId,
    flag: bool,
    access: crate::core::world_core::WorldAccess,
    ...
    check_body_target_with_access(core, body, access)?;
    unsafe { ffi::b2Body_SetBullet(raw_body_id(body), flag) };
    Ok(())
}

pub(crate) fn try_body_enable_contact_recycling_with_access(
    core: &WorldCore,
    body: BodyId,
    flag: bool,
    access: crate::core::world_core::WorldAccess,
    ...
    check_body_target_with_access(core, body, access)?;
    unsafe { ffi::b2Body_EnableContactRecycling(raw_body_id(body), flag) };
    Ok(())
}

pub(crate) fn try_body_enable_contact_events_with_access(
    core: &WorldCore,
    body: BodyId,
    flag: bool,
    access: crate::core::world_core::WorldAccess,
    ...
    check_body_target_with_access(core, body, access)?;
    unsafe { ffi::b2Body_EnableContactEvents(raw_body_id(body), flag) };
    Ok(())
}

pub(crate) fn try_body_enable_hit_events_with_access(
    core: &WorldCore,
    body: BodyId,
    flag: bool,
    access: crate::core::world_core::WorldAccess,
    ...
    check_body_target_with_access(core, body, access)?;
    unsafe { ffi::b2Body_EnableHitEvents(raw_body_id(body), flag) };
    Ok(())
}

pub(crate) fn try_body_set_name_with_access(
    core: &WorldCore,
    body: BodyId,
    name: &str,
    access: crate::core::world_core::WorldAccess,
    ...
    check_body_target_with_access(core, body, access)?;
    let name = crate::body::check_valid_body_name(name)?;
    check_body_target_with_access(core, body, access)?;
    unsafe { ffi::b2Body_SetName(raw_body_id(body), name.as_ptr()) };
    Ok(())
}
...
impl World {
    ...
    pub fn try_set_body_position_and_rotation<V: Into<Position>>(
        ...
        try_set_body_position_and_rotation_with_access(
            &self.core,
            body,
            p,
            angle_radians,
    ...
    pub fn try_set_body_linear_velocity<V: Into<Vec2>>(
        ...
        try_set_body_linear_velocity_with_access(
            &self.core,
            body,
            v,
            crate::core::world_core::WorldAccess::Idle,
    ...
    pub fn try_set_body_angular_velocity(
        ...
        try_set_body_angular_velocity_with_access(
            &self.core,
            body,
            w,
            crate::core::world_core::WorldAccess::Idle,
    ...
    pub fn try_body_apply_linear_impulse_to_center<V: Into<Vec2>>(
        ...
        try_body_apply_linear_impulse_to_center_with_access(
            &self.core,
            body,
            impulse,
            wake,
    ...
    pub fn try_body_apply_angular_impulse(
        ...
        try_body_apply_angular_impulse_with_access(
            &self.core,
            body,
            impulse,
            wake,
    ...
    pub fn try_body_clear_forces(&mut self, body: BodyId) -> crate::error::ApiResult<()> {
        try_body_clear_forces_with_access(
            &self.core,
            body,
            crate::core::world_core::WorldAccess::Idle,
        )
    ...
    pub fn body_enable_contact_recycling(&mut self, body: BodyId, flag: bool) {
        assert_body_target(&self.core, body);
        crate::body::body_enable_contact_recycling_impl(body, flag)
    }

    pub fn try_body_enable_contact_recycling(
        &mut self,
        body: BodyId,
        flag: bool,
    ) -> crate::error::ApiResult<()> {
